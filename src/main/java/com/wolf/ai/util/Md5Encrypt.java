...
public class Md5Encrypt {
	String DEFAULT_PASSWORD_KEY = "Ruimin.Internet.Technology.Co.Ltd.Fourteen.DWMNTH2CJFLCWL";
	...
	public String encrypt(String plaintext) {
		return getMD5ofStr(DEFAULT_PASSWORD_KEY + plaintext);
	}

	public static void main(String[] args) {
		Md5Encrypt m = Md5Encrypt.getInstance();
		System.out.println(m.encrypt("admin"));
		m = Md5Encrypt.getInstance();
		System.out.println(m.encrypt("ad"));
	}
}